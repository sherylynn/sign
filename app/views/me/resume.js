...
//import PouchDB from 'pouchdb' import 'pouchdb-asyncstorage-down'
...
export default class Resume extends Component {
  ...
  async _login() {
    ...
    if (data.success) {
      ...
      //加入数据到本地
      try {
        let response = await db_local.put({
          ...user,
          _id: 'user',
    ...
    return (
      <ScrollView style={{
        ...
        <View style={styles.container}>
          ...
          {this.props.title == '资料' && this.props.login_state == false
            ? <View style={styles.inputRow}>
                <Text>注册时间</Text><TextInput
                  style={styles.input}
                  placeholder={this.props.user.reg_time}
                  value={this.props.user.reg_time}/>
              </View>
            : null
}
          {this.props.title == '资料' && this.props.login_state == false
            ? <View style={styles.inputRow}>
                <Text>上次登录时间</Text><TextInput
                  style={styles.input}
                  placeholder={this.props.user.log_time}
                  value={this.props.user.log_time}/>
              </View>
            : null
}
          {this.props.title == '资料' && this.props.login_state == false && this.props.user.qrcode
            ? <QRCode value={this.props.user.qrcode} />
            : null
}
          {this.props.login_state == true
            ? <View>
